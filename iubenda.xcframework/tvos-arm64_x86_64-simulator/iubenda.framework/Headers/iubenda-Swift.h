...
SWIFT_CLASS("_TtC7iubenda4Cons")
@interface Cons : NSObject
@property (nonatomic, copy) NSString * _Nonnull rand;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull OnPopupClosed;)
+ (NSNotificationName _Nonnull)OnPopupClosed SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, strong) Cons * _Nullable cons;
@property (nonatomic, strong) Uspr * _Nullable uspr;
@property (nonatomic, strong) TCF2Data * _Nullable tcfv2InAppTCData;
@property (nonatomic, copy) NSString * _Nullable preferenceId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) BOOL useNonStandardTexts;
...
enum UsprOptOut : NSInteger;
SWIFT_CLASS("_TtC7iubenda4Uspr")
@interface Uspr : NSObject
@property (nonatomic) enum UsprOptOut s;
@property (nonatomic) enum UsprOptOut sh;
@property (nonatomic) enum UsprOptOut adv;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, UsprOptOut, open) {
  UsprOptOutNOTAPPLICABLE = -1,
  UsprOptOutNO = 0,
  UsprOptOutYES = 1,
};
